  ...
  const EXP = [
    ...
    },
    {
      ...
      html:
        ...
        '<h4>Research agenda (short)</h4><ol class="moves compact"><li>Why transparency sometimes fails or backfires</li><li>Defining and measuring explainability consistently</li><li>Longitudinal and field studies</li><li>Emerging-market and cross-cultural evidence (e.g. India)</li><li>A conditional view: when transparency resolves vs intensifies the paradox</li><li>High-stakes services such as finance and healthcare</li></ol>' +
        ...
        '<div class="note">Limits acknowledged in the report: single database (Scopus), single reviewer, journal-tier filter.</div>',
    },
    {
